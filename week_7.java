...
class Loan 
{
    ...
    private void calculateMonthlyPayment() 
    {
        ...
        this.monthlyPayment = (principal * r * Math.pow(1 + r, termMonths)) / (Math.pow(1 + r, termMonths) - 1);
    }
...
public class week_7
{
    ...
    static void registerUser(Scanner sc) 
    {
        ...
        // Temporary user object to link with account
    ...
    static void showAccountMenu(Scanner sc, User user) 
    {
        ...
        while (session) 
        {
            ...
            System.out.println("5. View Loan");
            ...
            switch (option) 
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    Loan existingLoan = user.getLoan();
                    if (existingLoan != null) 
                    {
                        existingLoan.displayLoanDetails();
                    } 
                    else 
                    {
